...
In R, the basic objects is vector. It is an ordered set of data containing one or more elements. 
...
The power of programming languega is based on the possibility to describe the algorithm (= what will be computed) regardless of the actual data. Here we need variables, which can represent the data. 
...
# The command assigned "emptiness" as the value of the variable:
academics
```
