...
```{r}
academics$citationsPerYear <- NULL
citationsPerYear <- with(academics, citations / workingYears)
# citationsPerYear is not added to academics
academics

# If you want to add it, write like this:
academics$citationsPerYear <- with(academics, citations / workingYears)
```
